...
This repo contains the thought process on adding a custom Robot into OIGE. It's mostly duct taped code that later is added into [OmniIsaacGymEnvs](https://github.com/boredengineering/OmniIsaacGymEnvs)
